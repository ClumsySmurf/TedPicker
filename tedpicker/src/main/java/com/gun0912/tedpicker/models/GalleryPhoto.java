...
public class GalleryPhoto implements Serializable {
    ...
    public GalleryPhoto(final Builder builder) {
        this.path = builder.mPath;
        this.imageId = builder.mImageId;
        this.dateAdded = builder.mDateAdded;
    }

    public static GalleryPhoto from(final Cursor cursor) {
        return Builder.from(cursor).build();
    }

    public static GalleryPhoto from(final Uri uri) {
        return Builder.from(uri).build();
    }

    @Override
    public boolean equals(Object o) {
        return o instanceof GalleryPhoto && ((GalleryPhoto) o).path.equals(path);
    }
    ...
    public static class Builder {
        ...
        public static Builder from(final Cursor cursor) {
            ...
            return new GalleryPhoto.Builder(path)
                    .imageId(imageId)
                    .dateAdded(dateAdded)
                    ;
